<div class="fixed pin-t pin-x z-40">
    ...
    <nav class="flex items-center justify-between text-black bg-navbar shadow-xs h-16">
        ...
        <div class="block mx-4 flex items-center">
            ...
            <larecipe-button tag="a" href="https://codecanyon.net/item/ultimate-loan-manager/19891884" target="__blank" type="black" class="mx-2 px-4">
                Buy Now
            </larecipe-button>
            ...
            @auth
                ...
                <larecipe-dropdown>
                    <larecipe-button type="white" class="ml-2">
                        {{ (auth()->user()->first_name. ' '.auth()->user()->last_name) ?? 'Account' }} <i class="fa fa-angle-down"></i>
                    </larecipe-button>
